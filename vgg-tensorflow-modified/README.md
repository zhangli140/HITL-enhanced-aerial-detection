# Modified Tenforflow VGG

## Purpose
We revised the code to train VGG, because we want to get the last layer's results for learning patterns for different classes for detection.

The stand-alone usage keeps the same with its origional version.

## Origional Version Reference 
